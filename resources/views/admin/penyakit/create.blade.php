<x-layout-admin>
    <div class="card w-full p-6 bg-base-100 shadow-xl">
        ...
        <div class="h-full w-full pb-6 bg-base-100">
            <form action="{{ route('admin.penyakit.store') }}" method="post" class="overflow-x-auto w-full"
                ...
                <div class="form-control w-full mt-4">
                    ...
                    <textarea name="deskripsi" id="deskripsi" class="textarea" placeholder="Type here"></textarea>
                    @error('deskripsi')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="form-control w-full mt-4">
                    ...
                    <textarea name="solusi" id="solusi" class="textarea" placeholder="Type here"></textarea>
                    @error('solusi')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
