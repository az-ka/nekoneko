        ...
        <div class="-mx-4 flex flex-wrap items-center">
            <div class="w-full px-4">
                <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                    <h1
                        ...
                        Neko Care - Sistem Pakar Untuk Diagnosa Penyakit Pada Kucing
                    </h1>
                    <p
                        class="mx-auto mb-10 max-w-[600px] text-base text-[#e4e4e4] sm:text-lg sm:leading-relaxed md:text-xl md:leading-relaxed">
                        Neko Care adalah sistem pakar yang membantu Anda mendiagnosa penyakit pada kucing dengan
                        cepat dan akurat. Temukan solusi kesehatan yang tepat untuk kucing kesayangan Anda dengan
                        mudah.
                    </p>
                    <ul class="mb-10 flex flex-wrap items-center justify-center">
                        <li>
                            <a href="{{ route('pengguna.diagnosa.index') }}"
            ...
            <div class="w-full px-4">
                <div class="wow fadeInUp relative z-10 mx-auto max-w-[845px]" data-wow-delay=".25s">
                    <div class="mt-16">
                        <img src={{ asset('assets/images/hero/cat-hero2.png') }} alt="hero"
