            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
                    <div class="mb-10 w-full">
                        <a href="javascript:void(0)" class="mb-0 inline-block max-w-full">
                        ...
                        <ul class="flex flex-wrap items-center">
                            <li>
                                <a href="https://tailgrids.com" rel="nofollow noopner" target="_blank"
                                    ...
                                    <img src={{ asset('assets/images/footer/brands/tailgrids.svg') }} alt="tailgrids" />
                                </a>
                            </li>
                            <li>
                                <a href="https://ayroui.com" rel="nofollow noopner" target="_blank"
                                    class="mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]">
                                    <img src={{ asset('assets/images/footer/brands/ayroui.svg') }} alt="ayroui" />
                                </a>
                            </li>
                            <li>
                                <a href="https://ecommercehtml.com" rel="nofollow noopner" target="_blank"
                                    class="mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]">
                                    <img src={{ asset('assets/images/footer/brands/ecommerce-html.svg') }}
                                        alt="ecommerce-html" />
                                </a>
                            </li>
                            <li>
                                <a href="https://graygrids.com" rel="nofollow noopner" target="_blank"
                                    class="mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]">
                                    <img src={{ asset('assets/images/footer/brands/graygrids.svg') }}
                                        alt="graygrids" />
                                </a>
                            </li>
                            <li>
                                <a href="https://lineicons.com" rel="nofollow noopner" target="_blank"
                                    class="mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]">
                                    <img src={{ asset('assets/images/footer/brands/lineicons.svg') }}
                                        alt="lineicons" />
                                </a>
                            </li>
                            <li>
                                <a href="https://uideck.com" rel="nofollow noopner" target="_blank"
                                    class="mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]">
                                    <img src={{ asset('assets/images/footer/brands/uideck.svg') }} alt="uideck" />
                                </a>
                            </li>
                        </ul>
                    </div>
